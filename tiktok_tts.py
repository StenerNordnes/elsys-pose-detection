...
tiktok_tts_session_id = os.getenv('TIKTOK_SESSIONID')
...
def main():
    ...
    args = argparse.Namespace(voice="en_us_007", text="Hello sassjo, you have now logged in", session={tiktok_tts_session_id}, file=None, name="voice.mp3", play=False)
